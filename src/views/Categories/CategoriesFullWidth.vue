                                ...
                                <div class="widget-content">
                                    ...
                                    <ul class="row ul-mh">
                                        <li class="col-md-4 col-sm-4 col-xs-12">
                                            <article class="entry-item">
                                                <div class="entry-thumb">
                                                    <a href="#"><img src="images/p9/1.jpg" alt=""></a>
                                                </div>
                                        ...
                                        <li class="col-md-4 col-sm-4 col-xs-12">
                                            <article class="entry-item">
                                                <div class="entry-thumb">
                                                    <a href="#"><img src="images/p9/2.jpg" alt=""></a>
                                                </div>
                                                <div class="entry-content">
                                                    <div class="ct-title-5">
                                                        <h5>popular</h5>
                                        ...
                                        <li class="col-md-4 col-sm-4 col-xs-12">
                                            <article class="entry-item">
                                                <div class="entry-thumb">
                                                    <a href="#"><img src="images/p9/3.jpg" alt=""></a>
                                                </div>
                                                <div class="entry-content">
                                                    <div class="ct-title-5">
                                                        <h5>funny</h5>
                            ...
                            <div class="woocommerce-main-primary">
                                ...
                                <div class="woocommerce-main-content">
                                    ...
                                    <ul class="ul-mh row">
                                        ...
                                        <!-- product-item --><li class="col-md-3 col-sm-3 col-xs-3">
                                            <article class="entry-item ct-item-4 style-02">
                                                <div class="entry-thumb">
                                                    <a href="#">
                                                        <img src="images/p2/2.jpg" alt="">
