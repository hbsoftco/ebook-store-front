  ...
  <div>
          ...
          <div class="col-md-3 col-sm-3 col-xs-3">
            <div class="widget reading-module-intro-2">
              <div class="widget-content">
                ...
                <p>
                  This is Photoshop's version of Lorem ain gravida nibh vel
                  velit ctor aliquet. an itudin, lorem quis bibendum auctoisi
                  elit
                </p>
                <p>
                  Duis sed odio sit amet nibh vulputate us a sit amet mauris.
                  Morbi accumsan .
                </p>
    ...
    <section class="slide-area">
      ...
      <div class="slide-container">
        <nav class="slide-nav">
          <h3 class="ct-title-1">Main Menu</h3>
          <ul class="slide-menu">
        ...
        <nav class="slide-nav">
          <h3 class="ct-title-1">Discover Products</h3>
          <ul class="slide-menu">
            <li>
              <a href="#">Everything</a>
            </li>
